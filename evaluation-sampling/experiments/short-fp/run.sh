...
EXPERIMENT_TAG="short-fp"

$RUN_DIR/../jfs-container.sh /tmp/evaluation-sampling/experiments/$EXPERIMENT_TAG/test-jfs.sh
#$RUN_DIR/../smtsampler-container.sh /tmp/evaluation-sampling/experiments/$EXPERIMENT_TAG/test-smtsampler.sh
$RUN_DIR/../qsampler-container.sh /tmp/evaluation-sampling/experiments/$EXPERIMENT_TAG/test-qsampler.sh

$RUN_DIR/../jfs-container.sh /tmp/evaluation-sampling/src/sqlite/join-all-dbs.sh --input-dir /tmp/evaluation-sampling/results --output-db /tmp/evaluation-sampling/results/output.db
